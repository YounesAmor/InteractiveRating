...
function myParams(Component) {
  return (props) => <Component navLocation={useLocation()} />;
}

class ThankYouPage extends Component {
  render() {
    console.log(this.props.navLocation.state.rating);
    return (
      <div className="bg-darkBlue lg:w-[400px] lg:h-[400px] sm:w-[350px] sm:h-[400px]">
        <div id="wrapper" className="m-10">
          <div className="flex flex-row justify-center items-center lg:mt-[45px]">
            <svg
              className="lg:w-[180px] lg:h-[100px] sm:w-[165px] sm:h-[100px]"
          ...
          <p className="inline-block border rounded-full bg-gray-700 border-transparent font-Overpass text-sm text-orange p-2 lg:mt-[35px] sm:mt-[25px]">
            You selected {this.props.navLocation.state.rating} out of 5
          </p>
          <p className="text-3xl font-Overpass text-white my-[20px]">
            Thank You!
          </p>
          <p className="text-lightGrey text-sm ">
            We appreciate you taking the time to give a rating. if you ever need
            more support, please don't hesitate to stay in touch!
          </p>
        </div>
      </div>
    );
...
export default myParams(ThankYouPage);
